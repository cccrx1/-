...
def build_run_signature(cfg: RuntimeConfig) -> Dict[str, object]:
    return {
        ...
        "aux_loss_cap_ratio": cfg.aux_loss_cap_ratio,
        "adaptive_mode": cfg.adaptive_mode,
        "adaptive_initial_threshold": cfg.adaptive_initial_threshold,
        "adaptive_final_threshold": cfg.adaptive_final_threshold,
        "adaptive_warmup_ratio": cfg.adaptive_warmup_ratio,
