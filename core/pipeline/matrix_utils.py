...
CASE_TO_CLI_FLAG = {
    ...
    "pdb_trigger_type": "--pdb-trigger-type",
    "pdb_pix_value": "--pdb-pix-value",
    "pdb_target_shift": "--pdb-target-shift",
    "pdb_weight": "--pdb-weight",
    "pdb_batch_ratio": "--pdb-batch-ratio",
    "pdb_warmup_ratio": "--pdb-warmup-ratio",
    "ssl_warmup_ratio": "--ssl-warmup-ratio",
    "aux_loss_cap_ratio": "--aux-loss-cap-ratio",
    "adaptive_mode": "--adaptive-mode",
    "adaptive_initial_threshold": "--adaptive-initial-threshold",
    "adaptive_final_threshold": "--adaptive-final-threshold",
    "adaptive_warmup_ratio": "--adaptive-warmup-ratio",
    "no_pdb_inference_trigger": "--no-pdb-inference-trigger",
    "skip_lc": "--skip-lc",
    "force_rebuild": "--force-rebuild",
    "attack_cache_root": "--attack-cache-root",
    "pretrained_benign_model_path": "--pretrained-benign-model-path",
    "pretrained_attack_model_path": "--pretrained-attack-model-path",
